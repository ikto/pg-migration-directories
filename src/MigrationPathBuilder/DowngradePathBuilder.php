...
class DowngradePathBuilder extends AbstractMigrationPathBuilder
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function chooseMigrations($migrationsMap, $startingVersion, $targetVersion)
    {
        ...
        while ($currentVersion > $targetVersion) {
            ...
            $localTargetVersion = min(array_keys($migrationsMap[$currentVersion]));
